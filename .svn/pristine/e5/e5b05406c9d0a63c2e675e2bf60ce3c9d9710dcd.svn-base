...
<%!public eWebOfficeServer EWEBOS = null;
		...
		try {
			...
			while (rs.next()) {
				...
				if ("loop".equals(bookMarkShowType)) {
					tempValue = getLoopValue(finishtype,caseId, valueSql, bookMarkShow,
							bookMarkEndType);
				} else if ("sysdate".equals(bookMarkShowType)) {
					tempValue = getCurrentDate();
				} else if ("single".equals(bookMarkShowType)) {
					tempValue = getSingleValue(finishtype,caseId, valueSql,bookMarkShow);
	...
	//获取循环显示
	public String getLoopValue(String finishtype,String caseId, String valueSql,
	...
	//获取单一显示
	public String getSingleValue(String finishtype,String caseId, String valueSql,
			String bookMarkShow) {
		String tempValue = "";
		String tempValuee = "";
		if (valueSql != null && !"".equals(valueSql)) {
