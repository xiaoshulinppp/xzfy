...
<td>&nbsp;<#if info.isPass=='1'>待审核<#else>待发布</#if></td>
<td><a href="../website/showArticle.action?funcCode=${funcCode}&articleId=${info.id}">查看</a></td>
<td>&nbsp;<a href="../website/revoke.action?funcCode=${funcCode}&articleId=${info.id}">撤销</a></td>
</tr>
</#list>
</tbody>
</table>
...
<script language="javascript">
			...
			function search(pNum){
				...
				document.form.action="myUnderReviewList.action"
