...
<div class="wal pageNow2">
      ...
      <#elseif articleInfo.column=="5">统计查询<#elseif articleInfo.column=="6">工作管理<#elseif articleInfo.column=="7">在线调查<#elseif articleInfo.column=="8">软件资料</#if></a> 
      ...
      <#if articleInfo.subColumn=="11">图片动态<#elseif articleInfo.subColumn=="12">行政复议工作动态<#elseif articleInfo.subColumn=="21">领导讲话
                 ...
                 <#elseif articleInfo.subColumn=="47">干预经营自主权<#elseif articleInfo.subColumn=="48">信息公开<#elseif articleInfo.subColumn=="49">其他</#if></a></div>
</div>
...
<div class="wal">
      ...
      <div class="pageBg5 newShow">
				...
				<div class="time">来源：${articleInfo.resource?default('')}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发布者：${articleInfo.author}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;时间：${articleInfo.releaseDate?default('')[0..10]}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;阅读次数：${articleInfo.viewCount?default(0)}</div>
