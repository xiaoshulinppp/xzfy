...
--
-- Dumping data for table `u_user_group`
--

LOCK TABLES `u_user_group` WRITE;
/*!40000 ALTER TABLE `u_user_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `u_user_group` ENABLE KEYS */;
UNLOCK TABLES;
