...
--
-- Table structure for table `u_group_role`
--
...
--
-- Dumping data for table `u_group_role`
--

LOCK TABLES `u_group_role` WRITE;
/*!40000 ALTER TABLE `u_group_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `u_group_role` ENABLE KEYS */;
UNLOCK TABLES;
