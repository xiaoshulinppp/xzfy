...
<td>&nbsp;<#if info.isPass=='0'>退回<#else>待提交</#if></td>
<td><a href="../website/showArticle.action?funcCode=${funcCode}&articleId=${info.id}">查看</a></td>
<td>&nbsp;<a href="../website/reeditArticle.action?funcCode=${funcCode}&articleId=${info.id}">修改</a></td>
</tr>
</#list>
</tbody>
</table>
...
<script language="javascript">
			...
			function search(pNum){
				...
				document.form.action="showNotPassList.action"
