...
<!--wal-->
 ...
 <div class="formTitle2">当面接收复议申请2</div>
  ...
  <textarea name="xzfyInfo.money_file" id="peichang_file" class="textarea" style="overflow-y:visible;"></textarea>
   ...
   <tr id="jddlr" style="display:none">
    ...
    <input name="xzfyInfo.agent_name" type="text" id="dlrname"
     altname="委托代理人姓名项" class="input2"></td>
    <th>是否有授权委托书：</th>
    <td>
...
<div border="0" >
	<div class="btn" >
	<div class="fl" >
		<a href="#" title="请在页面上修改案件基本信息，其他接待记录可以直接在笔录上修改。您在笔录上所做修改，不会自动在页面上改动"  onclick="javascript:saveDoc();return false;">接待笔录</a>
		<a href="#" title="请根据本单位实际要求使用"  onclick="javascript:saveDoc2();return false;">生成收据</a>
		<a href="#" title="请根据本单位实际要求使用"  onclick="javascript:saveDoc3();return false;" >地址确认单</a>
