...
<div class="xzfy mh-700">
 ...
 <p style = "margin:15px ;line-height:160%;font-size:20px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 您好！您的在线注册检索码为：${jiansuom}
 <br>发送至&nbsp;&nbsp;<font style="color:green">${fasongsj}</font>&nbsp;&nbsp;<a herf="" style="TEXT-DECORATION: underline">发送</a></p>
...
<font size="4"  style="text-align:center"><a href="../xzfy/download.action?xzfyId=${xzfyId}">下载申请书</a></font>
