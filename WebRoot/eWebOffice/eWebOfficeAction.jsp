...
<%!public eWebOfficeServer EWEBOS = null;
	...
	private static String DBNAME = "gfbxzfy";
	private static String DBPASS = "gfbxzfy";
	...
	public void DoSaveFile() {
		String caseId = EWEBOS.WebMsgGetString("CusParam");
		String s_RecordID = EWEBOS.WebMsgGetString("RecordID");
		...
		try {
			...
			while (rs.next()) {
				...
				if ("loop".equals(bookMarkShowType)) {
					tempValue = getLoopValue(caseId, valueSql, bookMarkShow,
							bookMarkEndType);
				} else if ("sysdate".equals(bookMarkShowType)) {
					tempValue = getCurrentDate();
				} else if ("single".equals(bookMarkShowType)) {
					tempValue = getSingleValue(caseId, valueSql,bookMarkShow);
	...
	//获取循环显示
	public String getLoopValue(String caseId, String valueSql,
	...
	//获取单一显示
	public String getSingleValue(String caseId, String valueSql,
			String bookMarkShow) {
		String tempValue = "";
		String tempValuee = "";
		if (valueSql != null && !"".equals(valueSql)) {
	...
	public void page_load(PageContext pagecontext) {
		...
		EWEBOS.SetLicense("MTE4MDqxsb6pytDIy8Px1f64rreo1saw7LmrytI6NDozOjI6MTcyLjI0LjE3Ni4xMDo6f356f8186147a0e7");
