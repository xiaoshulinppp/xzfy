...
<%
	...
	con = getConn();
	ms_all=ms_caseId+";"+ms_checkstatus;
	...
	if (ms_Action.equals("new")) {
		...
		response.sendRedirect("bac_default_cailiaochulidan_list.jsp?caseId="+ms_caseId+"&d_username"+ms_Author);
	}
	...
	ms_WebUrl += "eWebOffice/eWebOfficeAction2.jsp";
%>
