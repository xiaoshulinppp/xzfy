...
<body>
	<div id="bdy">
		...
		<div id="nav">
			您当前位置 &gt;&gt; <a href="default.jsp">eWebOffice示例首页</a> &gt;&gt; <a
				href="bookmark_list.jsp">书签管理</a> &gt;&gt; 编辑书签[ <span class=red><%=ms_ActionDesc%></span>]
		</div>
		<hr />
			...
			<table class="edit">
				<tr>
					...
					<td><input type="text" name="d_bookmarkname" size="50"
						class="txt" value="<%=ms_BookmarkName%>"></td>
				</tr>
				<tr>
					<td>书签说明</td>
					<td><input type="text" name="d_bookmarkdesc" size="50"
						class="txt" value="<%=ms_BookmarkDesc%>"></td>
				</tr>
				<tr>
					<td>书签备注</td>
					<td><input type="text" name="d_bookmarktext" size="50"
						class="txt" value="<%=ms_BookmarkText%>"></td>
				</tr>
				<tr>
