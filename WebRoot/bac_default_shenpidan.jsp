...
<body onload="ChangeFileType()">
	<div id="bdy">
		...
		<div id="nav">
			您当前位置 &gt;&gt; <a
				href="bac_default_shenpidan.jsp?caseId=<%=ms_cassid%>&d_username=<%=ms_userrName%>&d_checkstatus=<%=ms_checkstatus%>&finish_type=<%= ms_finishtype%>></a>">首页</a>
		</div>
		<hr />

		<table class="lst">
			<tr>
				<th colspan="2">审批单编辑管理——新版笔录编辑</th>
			</tr>
			<tr>
				<td>
					<form name="form1"
						...
						用户名： <input name="d_username" id="d_username" style="width: 75px"
							...
							value="编辑审批单" onclick="printNotice()">
						<script>
