	...
	<div id="bdy">
		...
		<table class="lst">
			...
			<tr>
				<td>
					<form name="form1"
						action="bac_document_shenpidan_edit.jsp?action=new" method="post">
						...
						while (rs.next()) {
							...
							if (rs.getString("D_FileType").toLowerCase().equals("doc")
								...
								s_Link = "<a href='bac_document_shenpidan_edit.jsp?action=norevision&d_templateid="
										...
										+ ms_cassid
										+ "'>阅读</a>"
										+ " <a style='color:red;' href='bac_document_shenpidan_delete.jsp?d_recordid="
										+ rs.getString("D_RecordID")
										+ "&d_username="
										+ ms_userrName
										+ "&caseId="
								...
								s_Link = "<a href='bac_document_shenpidan_edit.jsp?action=norevision&d_username="
										...
										+ ms_cassid
										+ "'>阅读</a>"
										+ " <a style='color:red;' href='document_shenpidan_delete.jsp?d_recordid="
										+ rs.getString("D_RecordID")
										+ "&caseId="
										+ ms_cassid + "'>删除</a>";
							}
