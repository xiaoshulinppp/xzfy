...
public class InfoDto2 implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -8092141047000847702L;
	/**
	 * 
	 */
...
//					市国土局（3000）、市规划委（3100）、市政府办公厅信息公开一处（0000
	...
	private String zhidaosj;
	private String fuyifs;
	private String shishiyuly;
	...
	public void setReceive_date(java.lang.String receive_date) {
	...
	public void setReceive_address(java.lang.String receive_address) {
	...
	public void setAdmit1_id(java.lang.String admit1_id) {
		this.admit1_id = admit1_id;
	}
	...
	public void setManage_type(java.lang.String manage_type) {
		this.manage_type = manage_type;
	}
	public java.lang.String getMatter_type() {
		return matter_type;
	}
	public void setMatter_type(java.lang.String matter_type) {
		this.matter_type = matter_type;
	}
	public java.lang.String getMatter_detail() {
		return matter_detail;
	}
	public void setMatter_detail(java.lang.String matter_detail) {
		this.matter_detail = matter_detail;
	}
	...
	public void setExecute_date(java.lang.String execute_date) {
		this.execute_date = execute_date;
	}
	public java.lang.String getIs_prof() {
		return is_prof;
	}
	public void setIs_prof(java.lang.String is_prof) {
		this.is_prof = is_prof;
	}
	public java.lang.String getIs_prof_detail() {
		return is_prof_detail;
	}
	public void setIs_prof_detail(java.lang.String is_prof_detail) {
		this.is_prof_detail = is_prof_detail;
	}
	public java.lang.String getRequire_fy() {
		return require_fy;
	}
	public void setRequire_fy(java.lang.String require_fy) {
		this.require_fy = require_fy;
	}
	public java.lang.String getBreak_right() {
		return break_right;
	}
	public void setBreak_right(java.lang.String break_right) {
		this.break_right = break_right;
	}
	public java.lang.String getXzfy_requset() {
		return xzfy_requset;
	}
	public void setXzfy_requset(java.lang.String xzfy_requset) {
		this.xzfy_requset = xzfy_requset;
	}
	public java.lang.String getXzfy_requset_retail() {
		return xzfy_requset_retail;
	}
	public void setXzfy_requset_retail(java.lang.String xzfy_requset_retail) {
		this.xzfy_requset_retail = xzfy_requset_retail;
	}
	...
	public void setMoney_detail(java.lang.String money_detail) {
		this.money_detail = money_detail;
	}
	public java.lang.String getMoney_file() {
		return money_file;
	}
	public void setMoney_file(java.lang.String money_file) {
	...
	public void setCheck_file(java.lang.String check_file) {
	...
	public void setTiaojie_from(java.lang.String tiaojie_from) {
		this.tiaojie_from = tiaojie_from;
	}
	public java.lang.String getTiaojie_to() {
		return tiaojie_to;
	}
	public void setTiaojie_to(java.lang.String tiaojie_to) {
		this.tiaojie_to = tiaojie_to;
	}
	public Integer getTiaojie_count() {
		return tiaojie_count;
	}
	public void setTiaojie_count(Integer tiaojie_count) {
	...
	public void setIssame_detail(String issame_detail) {
		this.issame_detail = issame_detail;
	}
	...
	public void setLaixin_name(String laixin_name) {
		this.laixin_name = laixin_name;
	}
	public String getLaixin_address() {
		return laixin_address;
	}
	public void setLaixin_address(String laixin_address) {
		this.laixin_address = laixin_address;
	}
	public String getLaixin_post() {
		return laixin_post;
	}
	public void setLaixin_post(String laixin_post) {
		this.laixin_post = laixin_post;
	}
	public String getLaixin_tel() {
		return laixin_tel;
	}
	public void setLaixin_tel(String laixin_tel) {
		this.laixin_tel = laixin_tel;
	}
	...
	public void setJdbl_flag(String jdbl_flag) {
		this.jdbl_flag = jdbl_flag;
	}
	public String getShouju_flag() {
		return shouju_flag;
	}
	public void setShouju_flag(String shouju_flag) {
		this.shouju_flag = shouju_flag;
	}
	public String getBztz_flag() {
		return bztz_flag;
	}
	public void setBztz_flag(String bztz_flag) {
		this.bztz_flag = bztz_flag;
	}
	public String getTiaojie_result() {
		return tiaojie_result;
	}
	public void setTiaojie_result(String tiaojie_result) {
		this.tiaojie_result = tiaojie_result;
	}
	...
	public void setReceive_detail(java.lang.String receive_detail) {
		this.receive_detail = receive_detail;
	}
	public java.lang.String getApp_advice_type() {
		return app_advice_type;
	}
	public void setApp_advice_type(java.lang.String app_advice_type) {
		this.app_advice_type = app_advice_type;
	}
	public java.lang.String getApp_advice_detail() {
		return app_advice_detail;
	}
	public void setApp_advice_detail(java.lang.String app_advice_detail) {
		this.app_advice_detail = app_advice_detail;
	}
	public java.lang.String getJiedai_file() {
		return jiedai_file;
	}
	public void setJiedai_file(java.lang.String jiedai_file) {
		this.jiedai_file = jiedai_file;
	}
	...
	public void setThird_agent(java.lang.String third_agent) {
		this.third_agent = third_agent;
	}
	public java.lang.String getApp_type1() {
		return app_type1;
	}
	public void setApp_type1(java.lang.String app_type1) {
		this.app_type1 = app_type1;
	}
	public java.lang.Integer getApp_type2() {
		return app_type2;
	}
	public void setApp_type2(java.lang.Integer app_type2) {
	...
	public void setXzfy_org(java.lang.String xzfy_org) {
		this.xzfy_org = xzfy_org;
	}
	public java.lang.String getUser1_id() {
		return user1_id;
	}
	public void setUser1_id(java.lang.String user1_id) {
		this.user1_id = user1_id;
	}
	public java.lang.String getUser1_name() {
		return user1_name;
	}
	public void setUser1_name(java.lang.String user1_name) {
		this.user1_name = user1_name;
	}
	public java.lang.String getUser2_id() {
		return user2_id;
	}
	public void setUser2_id(java.lang.String user2_id) {
		this.user2_id = user2_id;
	}
	public java.lang.String getUser2_name() {
		return user2_name;
	}
	public void setUser2_name(java.lang.String user2_name) {
		this.user2_name = user2_name;
	}
	public java.lang.String getUser3_id() {
		return user3_id;
	}
	public void setUser3_id(java.lang.String user3_id) {
		this.user3_id = user3_id;
	}
	public java.lang.String getUser3_name() {
		return user3_name;
	}
	public void setUser3_name(java.lang.String user3_name) {
		this.user3_name = user3_name;
	}
	...
	public void setLian_date(java.lang.String lian_date) {
		this.lian_date = lian_date;
	}
	...
	public void setBuzheng_from(java.lang.String buzheng_from) {
		this.buzheng_from = buzheng_from;
	}
	public java.lang.String getBuzheng_to() {
		return buzheng_to;
	}
	public void setBuzheng_to(java.lang.String buzheng_to) {
		this.buzheng_to = buzheng_to;
	}
	public String getLian_real_date() {
		return lian_real_date;
	}
	public void setLian_real_date(String lian_real_date) {
		this.lian_real_date = lian_real_date;
	}
	public String getFinish_real_date() {
		return finish_real_date;
	}
	public void setFinish_real_date(String finish_real_date) {
		this.finish_real_date = finish_real_date;
	}
	public java.lang.String getFenpei_id() {
		return fenpei_id;
	}
	public void setFenpei_id(java.lang.String fenpei_id) {
		this.fenpei_id = fenpei_id;
	}
	public java.lang.String getFenpei_name() {
		return fenpei_name;
	}
	public void setFenpei_name(java.lang.String fenpei_name) {
		this.fenpei_name = fenpei_name;
	}
	...
	public void setIsdelay_from(java.lang.String isdelay_from) {
		this.isdelay_from = isdelay_from;
	}
	public java.lang.String getIsdelay_to() {
		return isdelay_to;
	}
	public void setIsdelay_to(java.lang.String isdelay_to) {
		this.isdelay_to = isdelay_to;
	}
	...
	public void setIsstop_from(java.lang.String isstop_from) {
		this.isstop_from = isstop_from;
	}
	public java.lang.String getIsstop_to() {
		return isstop_to;
	}
	public void setIsstop_to(java.lang.String isstop_to) {
		this.isstop_to = isstop_to;
	}
	public java.lang.String getFinish_type() {
		return finish_type;
	}
	public void setFinish_type(java.lang.String finish_type) {
		this.finish_type = finish_type;
	}
	public java.lang.String getCheck_status() {
		return check_status;
	}
	public void setCheck_status(java.lang.String check_status) {
		this.check_status = check_status;
	}
	public java.lang.String getHas_tingzheng() {
		return has_tingzheng;
	}
	public void setHas_tingzheng(java.lang.String has_tingzheng) {
		this.has_tingzheng = has_tingzheng;
	}
	...
	public void setYijian_file(String yijian_file) {
		this.yijian_file = yijian_file;
	}
	public String getJianyi_file() {
		return jianyi_file;
	}
	public void setJianyi_file(String jianyi_file) {
		this.jianyi_file = jianyi_file;
	}
	public String getZhidaosj() {
		return zhidaosj;
	}
	public void setZhidaosj(String zhidaosj) {
		this.zhidaosj = zhidaosj;
	}
	public String getFuyifs() {
		return fuyifs;
	}
	public void setFuyifs(String fuyifs) {
		this.fuyifs = fuyifs;
	}
	public String getShishiyuly() {
		return shishiyuly;
	}
	public void setShishiyuly(String shishiyuly) {
		this.shishiyuly = shishiyuly;
	}
	public String getYanzhengsj() {
		return yanzhengsj;
	}
	public void setYanzhengsj(String yanzhengsj) {
		this.yanzhengsj = yanzhengsj;
	}
